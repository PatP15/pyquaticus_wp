...
if __name__ == '__main__':
    ...
    env = ParallelPettingZooEnv(pyquaticus_v0.PyQuaticusEnv(render_mode=RENDER_MODE, reward_config=reward_config, team_size=2))
    ...
    ppo_config.multi_agent(policies=policies, policy_mapping_fn=policy_mapping_fn, policies_to_train=["attacker-multi", "defender-multi"],)
